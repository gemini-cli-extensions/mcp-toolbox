...
# Binary. Set VERSION from the releases page:
# https://github.com/googleapis/mcp-toolbox/releases
export VERSION=1.11.0
# Pick your OS/arch: linux/amd64, darwin/arm64, darwin/amd64, windows/amd64, windows/arm64
export OS="darwin/arm64"
curl -L -o toolbox https://storage.googleapis.com/mcp-toolbox-for-databases/v$VERSION/$OS/toolbox
chmod +x toolbox
```
...
[py]: https://mcp-toolbox.dev/documentation/getting-started/local_quickstart/
[js]: https://mcp-toolbox.dev/documentation/getting-started/local_quickstart_js/
[go]: https://mcp-toolbox.dev/documentation/getting-started/local_quickstart_go/
...
- [Deploying Toolbox](https://mcp-toolbox.dev/documentation/deploy-to/)

These links track the current stable release of Toolbox. To read behaviour that
is not released yet, replace `mcp-toolbox.dev/` with `mcp-toolbox.dev/dev/`.
